  ...
  <section class="about">
    <div class="container-fluid"> 
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 vert-middle">
          <img class="img-responsive img-circle center-block profile-image" src="<?php echo get_template_directory_uri(); ?>/img/profile-image.jpg" alt="profile-image">
        </div>
  ...
  <section class="booking">
    <div class="container"> 
      <div class="row">
        ...
        <div class="col-xs-12 text-center">
        <?php echo do_shortcode('[contact-form-7 id="392" title="Contact form 1"]'); ?>
       </div>
     </div> <!-- End of row -->
   </div> <!-- End of container -->
 </section>
